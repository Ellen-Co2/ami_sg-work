...
dw3.md <-build.fmd(ms.dw3,15,2)
#10,2,
#15,6,MAE17.51
jpeg("3day15_6.jpg",width = 500,height = 500,bg="transparent",res=120)
...
jpeg("1stdayTBATS.jpg",width = 700,height = 500,bg="transparent",res=120)
fd.fig
dev.off()
...
res3<- tb.ff3$mean-tst3
res3a<- dw3.md$bst_fcast[["mean"]]-tst3
plot(res3a,type ="n",main= paste("Residuals "))
lines(res3a,col="red")
lines(res3,col="blue")
abline(h=mean(abs(res3a)),lty=1,col="red")
